...
if __name__ == '__main__':
    ...
    print("Leaderboard SSIM : {:.6f}".format((SSIM_acc4 + SSIM_acc8) / 2))
    print("="*10 + " Details " + "="*10)
    print("Leaderboard SSIM (acc4): brain {:.6f}, knee {:.6f}".format(SSIM_acc4_brain, SSIM_acc4_knee))
    print("Leaderboard SSIM (acc8): brain {:.6f}, knee {:.6f}".format(SSIM_acc8_brain, SSIM_acc8_knee))
